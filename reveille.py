...
async def help(ctx):
    ...
    description = (f'__Utility__\n'
                   ...
                   f':calendar: `{PREFIX}calendar (event_num)` - Lists chosen number of academic events from now.\n'
                   f':newspaper: `{PREFIX}events (\'today\'/\'tomorrow\')` - Lists TAMU student events for a specified day.\n'
                   f':mag: `{PREFIX}search [search_num] [*terms]` - Shows chosen number of results for search terms.\n\n'
                   f'__Courses & Schedule__\n'
                   f':notebook_with_decorative_cover: `{PREFIX}course [subject_code] [course_num]` - Returns info about a specified course.\n'
                   f':page_facing_up: `{PREFIX}schedule` - Enumerates classes in schedule with credit information.\n'
                   f':green_book: `{PREFIX}add_class [subject_code] [course_num] [section_num]` - Adds a class to schedule.\n'
                   f':closed_book: `{PREFIX}remove_class [subject_code] [course_num] [section_num]` - Removes a class from schedule.\n'
                   f':student: `{PREFIX}students [subject_code] [course_num]` - Finds the students taking a specified course.\n\n'
                   f'__Campus Dining__\n'
                   f':receipt: `{PREFIX}nom (\'open\'/\'all\')` - Generates on-campus dining locations filtered by mode.\n'
                   f':office: `{PREFIX}dining (\'hall\'/\'north\'/\'south\'/\'central\'/\'west\'/\'east\'/\'all\')` - Enumerates the `place_id` for dining locations in a specified area.\n'
                   f':hamburger: `{PREFIX}menu [place_id] (\'general\'/\'breakfast\'/\'lunch\'/\'dinner\') (\'simple\'/\'detailed\')` - Lists the dining menus for a specified dining location and menu type.\n\n'
                   f'__Extra & Fun__\n'
                   f':partly_sunny: `{PREFIX}weather (\'hourly\'/\'bidaily\') (step_num)` - Reports weather info given a specified mode and step.\n'
